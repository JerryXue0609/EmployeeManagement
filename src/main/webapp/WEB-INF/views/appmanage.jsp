...
<head>
    ...
    <script type="text/javascript" src="../js/company/company.appmanage.js"></script>
...
<table id="devicetab" title="我的申请管理" style="margin:0px 0px 0px 0px;">
</table>
    ...
    <form id="addfm" method="post">
        <table>
            ...
            <tr>
                <td>申请类型:</td>
                <td>
                    <input type="text" name="cate" id="cate" value="" class="form_control">
                </td>
            </tr>
            ...
            <tr>
                <td>申请内容:</td>
                <td>
                    <textarea type="text" name="content" id="content" value="" class="form_textArea" placeholder="请注明日期"></textarea>
                </td>
            </tr>
